    ...
    private void initComponents() {
        ...
        jPanel2 = new javax.swing.JPanel(){
            protected void paintComponent(Graphics g ) {
                ...
                for (int i = 0; i <= W/2; i += 5) {
                    ...
                    g.drawLine((W/2)+i,H/2,W/2,(H/2)+i);
                    g.drawLine((W/2)+i,H/2,W/2,(H/2)-i);
                    g.drawLine((W/2)-i,H/2,W/2,(H/2)+i);
                    g.drawLine((W/2)-i,H/2,W/2,(H/2)-i);
                }
        ...
        jPanel3 = new javax.swing.JPanel(){
            protected void paintComponent(Graphics g ) {
                ...
                for (int i = 0; i <= W/2; i += 4) {
                    ...
                    g.drawLine((W/2)+i,0,W/2,(H/2)-i);


                    g.drawLine((W/2)+i,H,W/2,(H/2)+i);
        ...
        jPanel6 = new javax.swing.JPanel(){
            protected void paintComponent(Graphics g ) {
                ...
                for (int i = 0; i <= W/2; i += 4) {
                    ...
                    g.drawLine((W/2),i,i,H-i);
                    g.drawLine((W/2),i,W-i,H-i);
        ...
        jPanel8 = new javax.swing.JPanel(){
            protected void paintComponent(Graphics g ) {
                ...
                int W = jPanel1.getWidth();
                int H = jPanel1.getHeight();
                for (int i = 0; i <= H*1.5; i += 7) {
                    g.drawOval((W/2)-(i/2),(H/2)-(i/2),i,i);
